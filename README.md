...
[![Version](https://img.shields.io/badge/version-0.7.0-green)](https://github.com/canigenix/FailureLab/releases)
...
Version 0.7.0 adds failure-signature analysis for diagnosing model weakness patterns and tracking how those patterns evolve across model versions.

Highlights:

Failure signatures across stress types

Localized, systemic, unstable, and low-risk signature classification

Structured failure diagnostics

Baseline-vs-candidate signature comparison

Signature regression and severity policy gates

Dominant-stress change detection

Multi-version signature history

Improving, stable, degrading, and volatile history trends

Signature-history policy gates

JSON export for signature workflows

New failurelab signature and failurelab signature-history CLI workflows

Expanded public Python API

These capabilities build on FailureLab's existing stress suites, experiment history, model progression analysis, robustness policies, visualization, model comparison, and CI regression gates.
...
Signature-history policy gates and JSON export
...
FailureLab can summarize failure behavior across stress types as a reusable signature. Signatures classify weaknesses as low-risk, localized, systemic, or unstable and identify the dominant stress pattern.

Signatures can be compared between model versions to detect regressions, severity changes, and shifts in the dominant failure mode. Structured diagnostics provide likely causes and recommended actions.

Signature history extends the same analysis across multiple checkpoints and classifies the overall trajectory as improving, stable, degrading, or volatile.
...
Both workflows support JSON export, Python API access, and policy gates for automated evaluation.
...
v0.7.0 provides structured JSON reports for:
...
v0.7.0 includes public interfaces for:
...
Failure signature analysis and comparison

Failure signature history and policy evaluation

Failure signature analysis and diagnostics

Signature history analysis
...
FailureLab v0.7.0 currently passes:
...
Failure signature analysis, comparison, and policy gates

Signature history, trend classification, export, and CLI behavior
...
failurelab-0.7.0-py3-none-any.whl

failurelab-0.7.0.tar.gz
...
v0.7.0 adds failure signatures, structured diagnostics, signature comparison and policy gates, multi-version signature history, trend classification, JSON export, and CLI workflows.
